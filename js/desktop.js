(function () {
  ...
  const virtualFS = {
    ...
    'Documents': { 'notes.txt': { type: 'file', icon: '📄', size: '2 KB', content: 'Shopping list:\n- milk\n- eggs\n- bread\n- new strings for the acoustic\n- maybe some sleep if i can find it' }, 'readme.md': { type: 'file', icon: '📄', size: '8 KB' }, 'budget.xlsx': { type: 'file', icon: '📊', size: '64 KB' }, 'hunt.txt': { type: 'file', icon: '🎯', size: '1 KB', content: '                          _,..,,,_\n                     \'``````^~"-,_`"-,_\n       .-~c~-.                    `~:. ^-.\n   `~~~-.c    ;                      `:.  `-,     _.-~~^^~:.\n         `.   ;      _,--~~~~-._       `:.   ~. .~          `.\n          .` ;\'   .:\'           `:       `:.   `    _.:-,.    `.\n        .\' .:   :\'    _.-~^~-.    `.       `..\'   .:      `.    \'\n       :  .\' _:\'   .-\'        `.    :.     .:   .\'`.        :    ;\n       :  `-\'   .:\'             `.    `^~~^`   .:.  `.      ;    ;\n        `-.__,-~                  ~-.        ,\' \':    \'.__.`    :\'\n                                     ~--..--\'     \':.         .:\'\n                                                     \':..___.:\'\n\n\"it bares it\'s fangs\nchasing it\'s prey\"' } },
