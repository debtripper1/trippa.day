(function () {
  ...
  const secretMap = [
    ...
    // Track 3: handled by Notepad typing in readme.txt (doUnlock)
  ...
  miniApps.notepad = {
    ...
    init: function (winId) {
      ...
      textarea.addEventListener('input', function () {
        ...
        if (w.currentFile === 'readme.txt' && !darkMode) {
          doUnlock(3);
        }
      });
    }
